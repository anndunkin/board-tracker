...
const api: BoardTrackerApi = {
  ...
  extractedImport: { pickFile: () => ipcRenderer.invoke('extracted-import:pick-file'), preview: (contents, sourceLabel, selections) => ipcRenderer.invoke('extracted-import:preview', contents, sourceLabel, selections ?? {}), commit: (contents, sourceLabel, selections) => ipcRenderer.invoke('extracted-import:commit', contents, sourceLabel, selections ?? {}), batches: () => ipcRenderer.invoke('extracted-import:batches'), copyPrompt: () => ipcRenderer.invoke('extracted-import:copy-prompt'), saveSchema: () => ipcRenderer.invoke('extracted-import:save-schema') }
};
