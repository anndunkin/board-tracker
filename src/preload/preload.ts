...
const api: BoardTrackerApi = {
  ...
  extractedImport: { pickFile: () => ipcRenderer.invoke('extracted-import:pick-file'), preview: (contents, sourceLabel, selections) => ipcRenderer.invoke('extracted-import:preview', contents, sourceLabel, selections ?? {}), commit: (contents, sourceLabel, selections) => ipcRenderer.invoke('extracted-import:commit', contents, sourceLabel, selections ?? {}), batches: () => ipcRenderer.invoke('extracted-import:batches') }
};
