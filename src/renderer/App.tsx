  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (modal.kind === 'company') {
        ...
        const vestingInput = (): Omit<VestingScheduleInput, 'compensation_id'> => ({ schedule_type: scheduleType, cliff_date: form.get('cliff_date') ? String(form.get('cliff_date')) : null, vesting_start: form.get('vesting_start') ? String(form.get('vesting_start')) : null, vesting_end: form.get('vesting_end') ? String(form.get('vesting_end')) : null, cadence: form.get('cadence') ? (String(form.get('cadence')) as VestingCadence) : null, notes: form.get('vesting_notes') ? String(form.get('vesting_notes')) : null });
        void submit(async () => {
